...
The cas_id attributes is used in 5 of the 6 CASFRI attribute tables and is only described here. The BC08 inventory has the following variations:
...
## map_sheet_id {.tabset}
  ...
  * do we need an isLength() helper function?
