...
The cas_id attributes is used in 5 of the 6 CASFRI attribute tables and is only described here. It has been modified slightly from the CAS_04 and is a concatenation of several attributes and strings ('bc08', src_filename, map_id,,feature_id, ogc_fid).

## orig_stand_id {.tabset}

  - Created from feature_id
