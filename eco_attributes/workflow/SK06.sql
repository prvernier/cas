...
CREATE TABLE translation_devel.sk06_sfv01_eco_devel AS SELECT * FROM translation.sk_sfv01_eco;
...
SELECT * FROM TT_Translate_sk06_eco_devel('rawfri', 'sk06_l1_to_sk_sfv_l1_map_200', 'ogc_fid');
-- SELECT * FROM TT_ShowLastLog('translation_devel', 'sk06_sfv01_eco_devel');
