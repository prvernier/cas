...
x = mutate(x, 
  ...
  non_for_veg = if_else((inventory_standard_cd=="V" | inventory_standard_cd=="I") & !is.na(bclcs_level_4) & is.na(non_for_veg),
  ...
  nat_non_veg = if_else((inventory_standard_cd=="V" | inventory_standard_cd=="I") & !is.na(land_cover_class_cd_1) & is.na(nat_non_veg), 
  ...
  nat_non_veg = if_else((inventory_standard_cd=="V" | inventory_standard_cd=="I") & !is.na(bclcs_level_4) & is.na(nat_non_veg),
  ...
  non_for_anth = if_else((inventory_standard_cd=="V" | inventory_standard_cd=="I") & !is.na(land_cover_class_cd_1) & is.na(non_for_anth), 
  ...
  non_for_veg = if_else(inventory_standard_cd=="F" & !is.na(bclcs_level_4) & is.na(non_for_veg),
                if_else(bclcs_level_4 %in% bclcs4$FRI[bclcs4$NFV==1], mapvalues(bclcs_level_4,bclcs4$FRI[bclcs4$NFV==1],bclcs4$CAS[bclcs4$NFV==1]), non_for_veg), non_for_veg),
  ...
  nat_non_veg = if_else(inventory_standard_cd=="F" & !is.na(bclcs_level_4) & is.na(nat_non_veg), 
                if_else(bclcs_level_4 %in% bclcs4$FRI[bclcs4$NNV==1], mapvalues(bclcs_level_4,bclcs4$FRI[bclcs4$NNV==1],bclcs4$CAS[bclcs4$NNV==1]), nat_non_veg), nat_non_veg),
...
### RAWFRI
  ...
  * The attribute **nat_non_veg** is generated from multiple attributes.
...
### RAWFRI
  ...
  * The attribute **non_for_anth** is generated from multiple attributes.
...
### RAWFRI
  ...
  * The attribute **non_for_veg** is generated from multiple attributes.
