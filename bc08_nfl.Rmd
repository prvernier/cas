...
# What's new
  ...
  * Revised some of the comments (2019-06-12)
  * Added link to forest management land base definition document (2019-05-20)
  * Added material to Overview and moved bc_vri01_nfl.xlsx to "lookup" folder (2019-05-16)
  * All NFL attributes are ready to reviewed (2019-05-14)

<br>

# Overview

Based on the CAS_04 database, NFL polygons do not overlap LYR polygons. In other words, a forested polygon cannot also include information on land cover components that occur within the boundaries and vice versa [is this the intent of CASFRI?].

Some specific notes:

  * Create NFL attributes for polygons where for_mgmt_land_base_ind=="N". This attribute is new (<a href="https://www2.gov.bc.ca/assets/gov/farming-natural-resources-and-industry/forestry/stewardship/forest-analysis-inventory/data-management/standards/forest_management_land_base_definition.pdf">see PDF</a>) and should be preferable to using crown_closure (as suggested by CASFRI or species_cd_1 as used in Perl code).
...
# NFL codes
lcc1 = read_excel("data/bc_vri01_nfl.xlsx", sheet="land_cover_class_cd_1")
bclcs4 = read_excel("data/bc_vri01_nfl.xlsx", sheet="bclcs_level_4")
nveg1 = read_excel("data/bc_vri01_nfl.xlsx", sheet="non_veg_cover_type_1")
nprod = read_excel("data/bc_vri01_nfl.xlsx", sheet="non_productive_descriptor_cd")
...
CAS_04 has one distinct value for this attribute: -1111. However, if needed, maybe this could be calculated from crown_closure for non-forested polygons.
...
CAS_04 has one distinct value for this attribute: -1111. However, if needed, maybe this could be calculated from proj_height_1 for non-forested polygons.
