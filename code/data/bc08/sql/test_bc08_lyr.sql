...
DROP TABLE If EXISTS translation.bc08_vri01_lyr;
CREATE TABLE translation.bc08_vri01_lyr (
...
COPY translation.bc08_vri01_lyr (rule_id, targetattribute, targetattributetype, validationrules, translationrules, description, descuptodatewithrules)
    FROM 'C:\Users\PIVER37\Documents\github\casfri\translation\tables\bc08_vri01_lyr.csv' DELIMITER ',' CSV HEADER;
...
CREATE TABLE translation.bc08_vri01_lyr_test AS SELECT * FROM translation.bc08_vri01_lyr WHERE rule_id>0;
