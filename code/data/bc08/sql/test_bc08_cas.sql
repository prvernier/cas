...
DROP TABLE If EXISTS translation.bc08_vri01_cas;
CREATE TABLE translation.bc08_vri01_cas (
...
COPY translation.bc08_vri01_cas (rule_id, targetattribute, targetattributetype, validationrules, translationrules, description, descuptodatewithrules)
    FROM 'C:\Users\PIVER37\Documents\github\casfri\translation\tables\bc08_vri01_cas.csv' DELIMITER ',' CSV HEADER;
...
DROP TABLE IF EXISTS translation.bc08_vri01_cas_test;
CREATE TABLE translation.bc08_vri01_cas_test AS SELECT * FROM translation.bc08_vri01_cas WHERE rule_id<15;
--SELECT * FROM translation.bc08_vri01_cas_test;

-- Translate the sample table! Create translation function
SELECT TT_Prepare('translation', 'bc08_vri01_cas_test', '_bc08');

-- Translate the sample!
SELECT * FROM TT_Translate_bc08('rawfri', 'bc08_test', 'translation', 'bc08_vri01_cas_test');
