...
DROP TABLE If EXISTS translation.bc08_vri01_nfl;
CREATE TABLE translation.bc08_vri01_nfl (
...
COPY translation.bc08_vri01_nfl (rule_id, targetattribute, targetattributetype, validationrules, translationrules, description, descuptodatewithrules)
    FROM 'C:\Users\PIVER37\Documents\github\casfri\translation\tables\bc08_vri01_nfl.csv' DELIMITER ',' CSV HEADER;
--SELECT * FROM translation.bc08_vri01_lyr;

DROP TABLE If EXISTS translation.bc_vri01_nfl;
CREATE TABLE translation.bc_vri01_nfl (
    source_val varchar,
    nfl varchar
);
COPY translation.bc_vri01_nfl (SOURCE_VAL, NFL)
    FROM 'C:\Users\PIVER37\Documents\github\casfri\translation\tables\lookup\bc_vri01_nfl.csv' DELIMITER ',' CSV HEADER;
...
DROP TABLE IF EXISTS translation.bc08_vri01_nfl_test;
CREATE TABLE translation.bc08_vri01_nfl_test AS SELECT * FROM translation.bc08_vri01_nfl WHERE rule_id>0;
--SELECT * FROM translation.bc08_vri01_nfl_test;

-- Translate the sample table! Create translation function
SELECT TT_Prepare('translation', 'bc08_vri01_nfl_test', '_bc08');

-- Translate the sample!
SELECT * FROM TT_Translate_bc08('rawfri', 'bc08_test', 'translation', 'bc08_vri01_nfl_test');
