...
DROP TABLE If EXISTS translation.bc08_vri01_eco;
CREATE TABLE translation.bc08_vri01_eco (
...
COPY translation.bc08_vri01_eco (rule_id, targetattribute, targetattributetype, validationrules, translationrules, description, descuptodatewithrules)
    FROM 'C:\Users\PIVER37\Documents\github\casfri\translation\tables\bc08_vri01_eco.csv' DELIMITER ',' CSV HEADER;
--SELECT * FROM translation.bc08_vri01_eco;

DROP TABLE If EXISTS translation.bc_vri01_eco;
CREATE TABLE translation.bc_vri01_eco (
    source_val varchar,
    eco varchar
);
...
DROP TABLE IF EXISTS translation.bc08_vri01_eco_test;
CREATE TABLE translation.bc08_vri01_eco_test AS SELECT * FROM translation.bc08_vri01_eco WHERE rule_id>0;
--SELECT * FROM translation.bc08_vri01_eco_test;

-- Translate the sample table! Create translation function
SELECT TT_Prepare('translation', 'bc08_vri01_eco_test', '_bc08');

-- Translate the sample!
SELECT * FROM TT_Translate_bc08('rawfri', 'bc08_test', 'translation', 'bc08_vri01_eco_test');
