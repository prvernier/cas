...
# What's new
  ...
  * First version created on 2019-06-06
...
x4 = read_csv("data/nb01/NB_0001.dst")
x1 = x %>% mutate(lyr=1)
...
### RAWFRI
```{r echo=FALSE, message=FALSE, warning=FALSE}  
dfSummary(x$l1trt[x$lyr==1], graph.col=FALSE, max.distinct.values=20)
```
...
### CAS_05
```{r echo=FALSE, message=FALSE, warning=FALSE}  
dfSummary(x$dist_1[x$lyr==1], graph.col=FALSE, max.distinct.values=20)
```
...
### RAWFRI
```{r echo=FALSE, message=FALSE, warning=FALSE}  
dfSummary(x$l2trt[x$lyr==2], graph.col=FALSE, max.distinct.values=20)
```
...
### CAS_05
```{r echo=FALSE, message=FALSE, warning=FALSE}  
dfSummary(x$dist_1[x$lyr==2], graph.col=FALSE, max.distinct.values=20)
```
...
### RAWFRI
```{r echo=FALSE, message=FALSE, warning=FALSE}  
dfSummary(x$l1trtyr[x$lyr==1], graph.col=FALSE, max.distinct.values=101)
```
...
### CAS_05
```{r echo=FALSE, message=FALSE, warning=FALSE}  
dfSummary(x$dist_yr_1[x$lyr==1], graph.col=FALSE, max.distinct.values=101)
```
...
### RAWFRI
```{r echo=FALSE, message=FALSE, warning=FALSE}  
dfSummary(x$l2trtyr[x$lyr==2], graph.col=FALSE, max.distinct.values=101)
```
...
### CAS_05
```{r echo=FALSE, message=FALSE, warning=FALSE}  
dfSummary(x$dist_yr_1[x$lyr==2], graph.col=FALSE, max.distinct.values=101)
```
