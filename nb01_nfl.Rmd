...
# What's new
  ...
  * First version created on 2019-06-06 but very incomplete i.e., no attributes created (see overview)
...
CAS_04
  * The NFL codes in the Perl script doesn't match the attribute values above, likely because it was cut and paste from another inventory
...
x4 = read_csv("data/nb01/NB_0001.nfl")
x1 = x %>% mutate(lyr=1)
