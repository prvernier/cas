...
### RAWFRI
```{r echo=FALSE, message=FALSE, warning=FALSE}  
dfSummary(y$trt[y$lyr==1], graph.col=FALSE, max.distinct.values=20)
```
...
### RAWFRI
```{r echo=FALSE, message=FALSE, warning=FALSE}  
dfSummary(y$trt[y$lyr==2], graph.col=FALSE, max.distinct.values=20)
```
...
### RAWFRI
```{r echo=FALSE, message=FALSE, warning=FALSE}  
dfSummary(y$trtyr[y$lyr==1], graph.col=FALSE, max.distinct.values=101)
```
...
### RAWFRI
```{r echo=FALSE, message=FALSE, warning=FALSE}  
dfSummary(y$trtyr[y$lyr==2], graph.col=FALSE, max.distinct.values=101)
```
