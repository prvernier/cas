...
casRender = function(inv) {
    if (inv=="ab06") {
        ...
        render("ab06_hdr.Rmd", output_dir="_site")
        render("ab06_cas.Rmd", output_dir="_site")
        render("ab06_lyr.Rmd", output_dir="_site")
        render("ab06_nfl.Rmd", output_dir="_site")
        render("ab06_dst.Rmd", output_dir="_site")
        render("ab06_eco.Rmd", output_dir="_site")
    } else if (inv=="ab16") {
        # Select attributes from ab16 and save as a tibble
        render("ab16_hdr.Rmd", output_dir="_site")
        render("ab16_cas.Rmd", output_dir="_site")
        render("ab16_lyr.Rmd", output_dir="_site")
        render("ab16_nfl.Rmd", output_dir="_site")
        render("ab16_dst.Rmd", output_dir="_site")
        render("ab16_eco.Rmd", output_dir="_site")
    } else if (inv=="bc08") {
        #render("bc08.Rmd")
        render("bc08_hdr.Rmd", output_dir="_site")
        render("bc08_cas.Rmd", output_dir="_site")
        render("bc08_lyr.Rmd", output_dir="_site")
        render("bc08_nfl.Rmd", output_dir="_site")
        render("bc08_dst.Rmd", output_dir="_site")
        render("bc08_eco.Rmd", output_dir="_site")
    } else if (inv=="nb01") {
        render("nb01_hdr.Rmd", output_dir="_site")
        render("nb01_cas.Rmd", output_dir="_site")
        render("nb01_lyr.Rmd", output_dir="_site")
        render("nb01_nfl.Rmd", output_dir="_site")
        render("nb01_dst.Rmd", output_dir="_site")
        render("nb01_eco.Rmd", output_dir="_site")
    } else {
        stop('There is no inventory with that name')
    }
}
