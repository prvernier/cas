...
The cas_id attributes is used in 5 of the 6 CASFRI attribute tables and is only described here. It has been modified slightly from the CAS_04 and is a concatenation of several attributes and strings ('ab16', CANFOR, src_filename, forest_id_2, ogc_fid).
