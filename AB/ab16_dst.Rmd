...
## dist_ext_upper_1, dist_ext_lower_1 {.tabset}
  ...
  * modext1 has 0 values which are not permitted in the CASFRI specifications; we have assigned them a code of -8885 similar to an EMPTY_STRING code
...
## dist_ext_upper_2, dist_ext_lower_2 {.tabset}
  ...
  * modext2 has 0 values which are not permitted in the CASFRI specifications; we have assigned them a code of -8885 similar to an EMPTY_STRING code
