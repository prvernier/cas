...
The cas_id attributes is used in 5 of the 6 CASFRI attribute tables and is only described here. It has been modified slightly from the CAS_04 and is a concatenation of several attributes and strings ('ab06', src_filename, trm_1, poly_num, ogc_fid).
