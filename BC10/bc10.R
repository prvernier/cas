...
casVars = c("stand_structure", "num_of_layers", "soil_moist_reg", "crown_closure_upper", "crown_closure_lower", "height_upper", "species_1", "species_per_1", "origin_upper", "height_lower", "origin_upper", "origin_lower", "site_inde", "non_for_veg", "nat_non_veg", "non_for_anth")
