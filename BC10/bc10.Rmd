...
if (!exists("x")) {
	...
	x = dbGetQuery(con, "SELECT * FROM rawfri.bc10 LIMIT 10000") %>%
		select(inventory_standard_cd, projected_date, for_mgmt_land_base_ind, soil_moisture_regime_1, bec_zone_code,
            map_id, l1_feature_id, line_7b_disturbance_history, feature_area_sqm, feature_length_m, reference_year,
...
The attribute **cas_id** attribute is a concatenation of several attributes and strings ("bc10", src_filename, map_id, feature_id, ogc_fid).
