...
-------------------------------------------------------------------------------
--DROP FUNCTION IF EXISTS TT_pei01_wetland_code(text, text, text);
...
------------------------------------------------------------
--DROP FUNCTION IF EXISTS TT_pei01_wetland_validation(text, text, text, text);
...
RETURNS boolean AS $$
  DECLARE
		wetland_code text;
  BEGIN
    PERFORM TT_ValidateParams('TT_pei01_wetland_validation',
...
-------------------------------------------------------------------------------
-- TT_pei01_wetland_translation(text, text, text, text)
--
