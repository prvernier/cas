...
SELECT * FROM TT_Translate_qc03_eco_devel('rawfri', 'bc10_l1_to_bc_vri01_l1_map_200', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'bc10_vri01_eco_devel', 'bc10_l1_to_bc_vri01_l1_map_200');
