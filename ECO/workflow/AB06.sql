...
SELECT TT_CreateMappingView('rawfri', 'ab06', 1, 'ab', 1, 200);
SELECT * FROM TT_Translate_ab06_eco_devel('rawfri', 'ab06_l1_to_ab_l1_map_200', 'ogc_fid'); -- 7 s.
SELECT * FROM TT_ShowLastLog('translation_devel', 'ab06_avi01_eco_devel', 'ab06_l1_to_ab_l1_map_200');
